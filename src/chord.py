...
class Chord:
    ...
    def generate_final_waveform(self, bpm):
        ...
        freq1, duration1 = freq_duration_generator(
            note1.pitch, note1.octave, length, bpm
        )
        freq2, duration2 = freq_duration_generator(
            note2.pitch, note2.octave, length, bpm
        )
        freq3, duration3 = freq_duration_generator(
            note3.pitch, note3.octave, length, bpm
        )
